...
mainActivityName = $(shell find . -name AndroidManifest.xml | xargs sed -e 's/_://g' | xmllint -xpath 'string(//activity[descendant::action[@name="android.intent.action.MAIN"]]/@name)' - )
